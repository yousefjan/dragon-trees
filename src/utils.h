...
#define BWIDTH	( WIDTH * INTERNAL_SCALE )
#define BHEIGHT	( HEIGHT * INTERNAL_SCALE )
#define BMIDX		( BWIDTH>>1 )
#define BMIDY		( BHEIGHT>>1 )
#define LWIDTH	( SHADOW_RES )
#define LHEIGHT	( SHADOW_RES )
